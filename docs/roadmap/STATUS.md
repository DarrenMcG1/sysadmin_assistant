...
> **A deploy was owed and was taken.**
> <!--check:deploy--> `sysadmin` was restarted at **2026-08-27 22:26:57**
> <!--check:daemon_start--> — by Session 106, which closed
> `SNAG-PORT-001`. Two sittings in a row have now moved code the daemon
> imports on every run, after a run of twenty that moved nothing a caller
> could observe.
>
