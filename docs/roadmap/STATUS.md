...
> restart was paid once, after the tree was frozen: daemon restarted at
> **2026-09-21 21:53:58** <!--check:deploy--> <!--check:daemon_start-->,
> `NRestarts` 12 → 13, `/health` 200. `SNAG-BRIEF-007` records what was
