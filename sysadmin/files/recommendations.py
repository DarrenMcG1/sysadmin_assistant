...
The file-organiser equivalent of :mod:`sysadmin.projects.recommendations`,
...
from sysadmin.core.contracts import FileRecommendationInfo
from sysadmin.files.forecast import ThresholdProjection, format_mb
...
def recommendations_for_audit(
    ...
    :func:`sysadmin.files.forecast.project_disk_thresholds`, or
