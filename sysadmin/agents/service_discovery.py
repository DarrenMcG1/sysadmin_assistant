...
The detection itself lives in :mod:`sysadmin.services.units`, which is
...
advice (:mod:`sysadmin.services.unit_recommendations`) hands the user a
snippet to paste.
"""
...
from sysadmin.agents.project_organiser import discover_projects
...
class ServiceDiscoveryAgent(BaseAgent):
    ...
    def _project_refs(config) -> list[ProjectRef]:
        ...
        :func:`sysadmin.agents.project_organiser.discover_projects` keeps
